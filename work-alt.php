                    ...
                    <div class="glide">
                        <div class="glide__track" data-glide-el="track">
                            <ul class="glide__slides">
                                <li class="glide__slide"><a href="./case/jbd-engineering.php"><img src="./assets/media/jbd-engineering-thumbnail.png" alt="Jbd Engineering website"></a></li>
                                <li class="glide__slide"><a href="./case/belcoast.php"><img src="./assets/media/belcoast-thumbnail.png" alt="Jbd Engineering website"></a></li>
                            </ul>
                        </div>
